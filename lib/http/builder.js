...
var JQueryAjaxRequestBuilder = /** @class */ (function () {
    ...
    JQueryAjaxRequestBuilder.prototype.addSecurityHeaders = function (added) {
    ...
    JQueryAjaxRequestBuilder.prototype.timeout = function (num) {
        this._timeout = num;
        return this;
    };
    /**
    ...
    JQueryAjaxRequestBuilder.prototype.httpRequest = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _options, response, headersStr, headers, pairs, _i, pairs_1, pair, _a, key, values;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _options = tslib_1.__assign({ url: this.url, contentType: this._contentType, dataType: this._dataType, headers: this._headers, timeout: this._timeout }, options);
                        this.xhr = this.$.ajax(_options);
                        return [4 /*yield*/, this.xhr];
                    case 1:
                        response = _b.sent();
                        headersStr = this.xhr.getAllResponseHeaders();
                        headers = {};
                        pairs = headersStr.split('\n');
                        for (_i = 0, pairs_1 = pairs; _i < pairs_1.length; _i++) {
                            pair = pairs_1[_i];
                            if (pair != "") {
                                _a = pair.split(':'), key = _a[0], values = _a.slice(1);
                                headers[key.toLowerCase()] = str_1.default.trim(values.join(':'));
                            }
                        }
                        return [2 /*return*/, {
                                data: response,
