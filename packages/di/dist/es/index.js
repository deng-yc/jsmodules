...
export function Register(name, scope = "Singleton") {
    if (!name) {
...
export function injectable(name, scope = "Singleton") {
...
export function Resolve(key, ...args) {
...
export function getInstance(Binding, args = [], scope) {
    if (!Binding.$$di_NAME) {
