...
import { kv_data, kv_data_encrypted } from './collections/KeyValue';
import { RxDbConnection } from './connection';
export class RxDbKeyValueStorage {
    __STORE_NAME__;
    encrypted;
    dbName;
    ...
    async getCollection() {
        ...
        if (this.encrypted) {
            return db.collections[kv_data_encrypted];
        }
        return db.collections[kv_data];
    }
    async getAllAsync() {
